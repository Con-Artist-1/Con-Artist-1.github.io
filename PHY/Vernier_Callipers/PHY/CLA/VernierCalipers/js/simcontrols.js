...
var cmn = {
    ...
    offsetOne: null,
    value_main: null,
    Main_Scl_reading: null,
    Vernr_Scl_Reading: null,
    Result: null,
    AdjstVal: null,
    ArrayVal_Four: null
}
...
function ini() { //Initialization.
    ...
    $("#Result_Icon_correct").css({
        "visibility": "hidden"
    });
    $("#Result_Icon_wrong").css({
        "visibility": "hidden"
    });
    $("#Reading").css({
        "visibility": "hidden"
...
$(document).ready(function() {
    ...
    //Dragg Function 	
    $("#Verier_Scale").draggable({
        revert: true,
        containment: "#sclDragger",
        axis: "x",
        revert: false,
        ...
        drag: function() { //drag function.
            ...
            $("#Scale_Needl").css({
                "left": cmn.offsetOne + MainPos + 9 + "px"
            });
            $("#Zoom_Scale").css({
                "left": -179 + Math.ceil(cmn.one) - 1 + "px"
            });
    ...
    function Bob_function() {
        ...
        $("#Object_Store").css({
            "background-image": "url(../PHY/CLA/VernierCalipers/images/sphere.png)"
        });
    ...
    function Iron_block_lngth() {
        ...
        $("#Object_Store").css({
            "background-image": "url(../PHY/CLA/VernierCalipers/images/IronBlock_Length.png)"
        });
        $("#Object_Store").css({
            "top": "261px",
            "left": "44px"
    ...
    function Iron_block_Breadth() {
        ...
        $("#Object_Store").css({
            "background-image": "url(../PHY/CLA/VernierCalipers/images/Iron_Block_B.png)"
        });
        $("#Object_Store").css({
            "width": Cmn_Width + "px",
            "height": Cmn_Height + "px",
            "top": Cmn_Top + "px",
            "background-size": Cmn_B_size + "px",
            "z-index": "0"
        });
        $("#sclDragger").css({
            "left": Cmn_SCLD_size + "px",
            "width": Cmn_SCLD_width + "px"
        });
    ...
    function Iron_block_Thickness() {
        ...
        $("#Object_Store").css({
            "background-image": "url(../PHY/CLA/VernierCalipers/images/Iron_Block_T.png)"
        });
        $("#Object_Store").css({
            "width": Tkns_width + "px",
            "height": Tkns_height + "px",
            "top": "261px",
            "background-size": Tkns_B_size + "px",
            "z-index": "0"
        });
        $("#sclDragger").css({
            "left": Tkns_SCLD_size + "px",
            "width": Tkns_SCLD_width + "px"
        });
    ...
    function Beaker_function() {
        ...
        $("#Object_Store").css({
            "background-image": "url(../PHY/CLA/VernierCalipers/images/Beaker_Big.png)"
        });
        $("#Verier_Scale").css({
            "left": set_Vrnr + "px"
        });
    ...
    function Beaker_depth() {
        ...
        $("#Object_Store").show();
        $("#Object_Store").css({
            "background-image": "url(../PHY/CLA/VernierCalipers/images/Beaker_Big_Two.png)"
        });
        ...
        $("#Object_Store").css({
            "top": "166px",
            "left": "421px",
            "height": depth_height + "px",
            "width": depth_width + "px",
            "background-size": depth_BSize + "px",
            "z-index": "0"
        });
        $("#sclDragger").css({
            "left": "35px",
    ...
    function Cylinder_Diameter_function() {
        ...
        $("#Object_Store").show();
        $("#Object_Store").css({
            "background-image": "url(../PHY/CLA/VernierCalipers/images/Cylinder_Diameter.png)"
        });
        $("#Verier_Scale").css({
            "left": "209px"
        });
        ...
        $("#Object_Store").css({
            "width": Diameter_Width + "px",
            "height": Diameter_Height + "px",
            "top": "261px",
            "background-size": Diameter_Bsize + "px",
            "left": "44px",
            "z-index": "0"
        });
        $("#sclDragger").css({
            "left": Diameter_SCLD + "px",
            "width": "350px"
        });
    ...
    function Cylinder_Length() {
        ...
        $("#TextBox").prop('disabled', true);
        $("#Object_Store").css({
            "background-image": "url(../PHY/CLA/VernierCalipers/images/Cylinder_Length.png)"
        });
        ...
        $("#Object_Store").css({
            ...
            "height": Cylinder_Height + "px",
            "top": "261px",
            "background-size": Cylinder_Bsize + "px",
            "left": "43px",
            "z-index": "0"
        });
        $("#sclDragger").css({
            "left": Cylinder_SCLD + "px",
            "width": "350px"
        });
    ...
    $("#IronBlock").click(function() {
        ...
        $("#Select_Measure,#FirstRDBttn,#Radio_Two,#Radio_Three,#ThirdRDBttn,#SecondRDBttn").css({
            "visibility": "visible"
        });
    ...
    $("#Beaker").click(function() {
        ...
        $("#Select_Measure,#FirstRDBttn,#Radio_Two,#SecondRDBttn").css({
            "visibility": "visible"
        });
        $("#Radio_Three,#ThirdRDBttn").css({
            "visibility": "hidden"
        });
