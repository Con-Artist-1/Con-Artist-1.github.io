...
var m, M = 0.05,
    T, diameter = 0.5,
    r;
var clr, vibrating = false,
    amplitude = 4;
var prevVal, paperFall = false,
    paperTop = 179,
    paperLmt = false;
var preValA = 1,
    preValB = 100;
...
function scaleAmotion(val) {
    ...
    if (valueA > magnet_position - 2) {
        ...
        $("#scaleA").css({
            'left': -39 - ((magnet_position - 2) * 38) + 'px'
        });
        $("#zoomBridgeA").css({
            'left': ((magnet_position - 2) * 2) + 'px'
        });
    ...
    $("#bridge_A_txt").css({
        'left': bridgeAlft - 21 + 'px'
    });
    if (bridgeAlft > paperLft - 15 && !paperFall) {
        $("#paperSmall").css({
            'left': (bridgeAlft + 15) + 'px'
        });
    }
...
function scaleBmotion(val) {
    ...
    if (valueB < magnet_position + 2) {
        ...
        $("#scaleB").css({
            'left': -3839 + ((100 - (magnet_position + 2)).toPrecision(3) * 38) + 'px'
        });
        $("#zoomBridgeB").css({
            'left': ((magnet_position + 2) * 2) + 'px'
        });
        ...
        $("#bridgeB").css({
            'left': 467 - ((100 - val) * 3.5) + 'px'
        });
        $("#scaleB").css({
            'left': -3839 + ((100 - val).toPrecision(3) * 38) + 'px'
        });
        $("#zoomBridgeB").css({
            'left': (val * 2) + 'px'
        });
    ...
    bridgeBlft = $('#bridgeB').position().left;
    $("#bridge_B_txt").css({
        'left': bridgeBlft - 12 + 'px'
    });
    if (bridgeBlft < paperLft + 15 && !paperFall) {
        $("#paperSmall").css({
            'left': (bridgeBlft - 15) + 'px'
        });
    }
    bridgeDist = valueB - valueA;
    setAmplitude();
...
window.onload = function() {
    ...
    $(document).ready(function() {
        ...
        $("#materialCombo").change(function() {
            ...
            $("#wire, #wireInWeight").css({
                'background-color': materialColor[material]
            });
            plotLine();
            calculateDistance();
            setAmplitude();
        ...
        $("#supply_type").change(function() {
            ...
            $("#bridgeB").css({
                'left': 467 - ((100 - valueB) * 3.5) + 'px'
            });
            $("#scaleB").css({
                'left': -3839 + ((100 - valueB).toPrecision(3) * 38) + 'px'
            });
            $("#zoomBridgeB").css({
                'left': (valueB * 2) + 'px'
            });
