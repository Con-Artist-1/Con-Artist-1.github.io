...
function hitFork() {
    ...
    clrWavelft = setInterval(function() {
        waveGenerator('#forkWavesLft', 2, -22)
    }, 1000);
    clrWaveRgt = setInterval(function() {
        waveGenerator('#forkWavesRgt', -22, 2)
    }, 1000);
    $("#tFork").animate({
        'top': '125px'
    });
