...
window.onload = function() {
    ...
    $(document).ready(function() {
        ...
        $("#default1,#default2,#default3").css({
        ...
        function changeCombo2(elemid) { //lead shot, Wire, Glass palate, Irregular Lamina
            $("#default0,#default1,#default2,#default3").css({
                display: displayArray[1]
            });
            ...
            switch (cmn.num) {
                case optionLabel[0]: //leadshot
                    ...
                    $("#images").css({
                        width: optWidth[cmn.randomNumbers] + "px",
                        height: optHeight[cmn.randomNumbers] + "px",
                        top: optPosTop[cmn.randomNumbers] + "px",
                        left: optPosLeft[cmn.randomNumbers] + "px"
                    });
                    $("#imgtext").css({
                ...
                case optionLabel[1]: //wire
                    ...
                    $("#images").css({
                        width: 5 + optWidth1[cmn.randomNumbers] + "px",
                        height: 5 + optHeight1[cmn.randomNumbers] + "px",
                        top: '210px',
                        left: '86px'
                    });
                    $("#imgtext").css({
                ...
                case optionLabel[2]: //Glass plate
                    ...
                    $("#images").css({
                        width: optWidth2[cmn.randomNumbers] + "px",
                        height: "80px",
                        top: optPosTop2[cmn.randomNumbers] + "px",
                        left: optPosLeft2[cmn.randomNumbers] + "px"
                    });
                    $("#imgtext").css({
                        margin: '-3px 0px 8px 40px',
                        padding: '109px 0px 0px 18px'
                    });
                    $("#graphpage").css({
                        display: displayArray[1]
                    });
                ...
                case optionLabel[3]: //Irregular Lamina 
                    ...
                    $("#imgtext").css({
                        margin: '-3px 0px 8px 26px',
                        padding: '86px 0px 0px 18px'
                    });
                    $("#graphpage").css({
                        display: displayArray[0]
                    });
        ...
        function shuffle() {
            ...
            //Wire
            $("#default1").css({
                width: optWidth1[cmn.randomNumbers] + "px",
                height: optHeight1[cmn.randomNumbers] + "px"
            });
            //Glass plate
            $("#default2").css({
                width: optWidth2[cmn.randomNumbers] + "px",
                ...
                if ($("#smallimg").is(':visible')) { //image  visible
                    if (cmn.test >= cmn.test3) { //up arrow function
                        ...
                        if ($('#dup').attr('src') == simPath + "images/" + imgarr[0]) { //leadshot
                            ...
                            $('#msblck1').css({
                                left: bgLeft + zoomleftscale[cmn.randomNumbers] + "px"
                            });
                            $('#css').css({
                                top: bgTop - zoomCsscale[cmn.randomNumbers] + "px"
                            });
                            ...
                            $('#css').css({
                                top: bgTop - zoomCsscale1[cmn.randomNumbers] + "px"
                            });;
                            ...
                            cmn.tsr = (cmn.msr + (correctedCsr * cmn.Lc)).toFixed(3);
                            $('#msblck1').css({
                                left: bgLeft + zoomleftscale2[cmn.randomNumbers] + "px"
                            });
                            $('#css').css({
                                top: bgTop - zoomCsscale2[cmn.randomNumbers] + "px"
                            });
                ...
                if ($("#smallimg").is(':visible')) { //up arrow 
                    if (cmn.test >= cmn.test3) {
                        ...
                        if ($('#dup').attr('src') == simPath + "images/" + imgarr[0]) { //LeadShot
                            ...
                            $('#msblck1').css({
                                left: bgLeft + Zoomblock[cmn.randomNumbers] + "px"
                            });
                            $('#css').css({
                                top: bgTop - ZoomCss[cmn.randomNumbers] + "px"
                            });
                        } else if ($('#dup').attr('src') == simPath + "images/" + imgarr[1]) { //Wire
                            ...
                            $('#css').css({
                                top: bgTop - ZoomCss1[cmn.randomNumbers] + "px"
                            });
                        } else if (($('#dup').attr('src') == simPath + "images/" + imgarr[4])) { //glass plate
                            ...
                            cmn.tsr = (Math.round((cmn.msr + (correctedCsr * cmn.lc1)) * 100) / 100).toFixed(3);
                            $('#msblck1').css({
                                left: bgLeft + Zoomblock2[cmn.randomNumbers] + "px"
                            });
                            $('#css').css({
                                top: bgTop - ZoomCss2[cmn.randomNumbers] + "px"
                            });
                        } else if (($('#dup').attr('src') == simPath + "images/" + imgarr[5])) { //irregular lamina
        ...
        $('.picker').on("click", function() {
            ...
            if (cmn.num == optionLabel[0]) {
                ...
                $('#smallimg').css({
                    "left": bgLeft + 43 + "px",
                    "top": bgTop + smallImgpos[cmn.randomNumbers] + "px"
                });
                $('#smallimg').toggle();
            }
            //wire positioning 
                ...
                $('#smallimg').css({
                    "left": bgLeft + 43 + "px",
                    "top": bgTop + smallImgpos1[cmn.randomNumbers] + "px"
                });
                $('#smallimg').toggle();
            }
            //glass plate positioning 
                ...
                $('#dup').css({
                    width: glasswidth[cmn.randomNumbers] + "px",
                    height: "79px"
                });
                $('#smallimg').css({
                    "left": bgLeft + 43 + "px",
                    "top": bgTop + smallImgpos2[cmn.randomNumbers] + "px"
                });
                $('#smallimg').toggle();
            }
            //lamina  
                ...
                if ($('#mainimage').css("visibility") == "visible") { //main screw guage page
                    ...
                    $('#smallimg').toggle();
                    $(".dropBox").prop("disabled", true);
                    if ($('#smallimg').css("display") == displayArray[1]) {
                        isclikedfunc();
                    }
                }
            }
        ...
        $('#mainimage2').smartZoom({
            'containerClass': 'mainimage2'
        });
