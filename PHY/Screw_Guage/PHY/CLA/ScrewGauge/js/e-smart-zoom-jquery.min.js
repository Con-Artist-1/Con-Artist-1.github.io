(function(e) {
    e.fn.smartZoom = function(t) {
        function i(e, t) {
            ...
            if (i.currentWheelDelta * t < 0) i.currentWheelDelta = 0;
        ...
        function m() {
            ...
            if (e.transitionObject) {
                if (e.transitionObject.cssAnimTimer) clearTimeout(e.transitionObject.cssAnimTimer);
                var t = e.originalSize;
                var r = E();
                var i = new Object;
                i[e.transitionObject.transition] = "all 0s";
                if (e.transitionObject.css3dSupported) {
                    i[e.transitionObject.transform] = "translate3d(" + r.x + "px, " + r.y + "px, 0) scale3d(" + r.width / t.width + "," + r.height / t.height + ", 1)"
                } else {
                    i[e.transitionObject.transform] = "translateX(" + r.x + "px) translateY(" + r.y + "px) scale(" + r.width / t.width + "," + r.height / t.height + ")"
                }
                n.css(i)
            } else {
                n.stop()
        ...
        var r = {
            init: function(t) {
                ...
                var o = e('<div id="' + r + '" class="' + settings.containerClass + '"></div>"');
                n.before(o);
                n.remove();
                o = e("#" + r);
                if (settings.containerClass == "") o.css({
                ...
                b();
                if (settings.touchEnabled == true) n.bind("touchstart.smartZoom", c);
                if (settings.mouseEnabled == true) {
                    if (settings.mouseMoveEnabled == true) n.bind("mousedown.smartZoom", a);
                    if (settings.scrollEnabled == true) {
                        o.bind("mousewheel.smartZoom", i);
                        o.bind("mousewheel.smartZoom DOMMouseScroll.smartZoom", s)
                    }
                }
            ...
            destroy: function() {
                ...
                r.before(n);
                w(n, t.originalPosition.left, t.originalPosition.top, t.originalSize.width, t.originalSize.height, 5);
